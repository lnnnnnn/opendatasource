...
/*    */ 
/*    */ public class LinkType_BusinessList extends LinkType_List
/*    */ {
/*    */   public LinkType_BusinessList()
/*    */   {
/* 16 */     super("philstar.businesslist");
/*    */   }
/*    */ 
/*    */   public LinkType_BusinessList(Site site)
/*    */   {
/* 21 */     super("philstar.businesslist");
...
/* 38 */         int rst = new Link(url, new LinkType_Business(), ELinkState.UNCRAWL, parentlink, super.getSite()).insert();
...
/* 54 */       Link nextPage = new Link(
					...
					new LinkType_BusinessList(super.getSite()), 
					ELinkState.UNCRAWL, 
					parentlink, 
					super.getSite()
				);
 ...
 * Qualified Name:     edu.nju.opsource.philstar.linktype.LinkType_BusinessList
