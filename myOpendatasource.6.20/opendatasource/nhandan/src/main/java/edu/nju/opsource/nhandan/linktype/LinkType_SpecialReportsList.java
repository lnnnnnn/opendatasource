...
public class LinkType_SpecialReportsList extends LinkType{
	 ...
	 public LinkType_SpecialReportsList() {
		super();
		// TODO Auto-generated constructor stub
	}
	 public LinkType_SpecialReportsList(String linkTypeName) {
		      super.setLinkTypeName(linkTypeName);
		    }
	public LinkType_SpecialReportsList(Site site) {
		//System.out.println("Politics_list-35:");
		//System.out.println(site);
		    super.setLinkTypeName("nhandan.specialReportsList");
		    this.site = site;
		  }
	...
	public boolean handle(Link parentlink) throws Exception {
     ...
     for (Element newItem : news) {
       ...
       {
         Link link = new Link(tmp.first().attr("abs:href"), new LinkType_SpecialReports(), ELinkState.UNCRAWL, parentlink, this.site);
     ...
     if ((nextPageE != null) && (nextPageE.size() != 0)) {
       ...
       this.nextPage = new Link(nextPageE
         .first().attr("abs:href"), new LinkType_SpecialReportsList(this.site), ELinkState.UNCRAWL, parentlink, this.site);
